...
| `08-krotki-cena-u-grafika.mp4` | Rzut 3D | 13 s | „Rzut 3D u grafika? 899 zł i tydzień.” | Wariant cenowy |
...
- **15 kredytów** zgodne z produkcją (`signup_credits_30`); uwaga: `apps/web/src/lib/data.ts:322` ma nieaktualne „5 kredytów”.
